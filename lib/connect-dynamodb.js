/*!
 * Connect - DynamoDB
 * Modified by Ryan Mits
 *
 * Copyright(c) 2019 humbly LLC <support@humbly.com>
 * MIT Licensed
 */
/**
 * Module dependencies.
        ...
        this.client.getItem(params, function (err, result) {
            ...
            if (err) {
                ...
                try {
                    ...
                    // No session sometimes? Why?
                    else if ((result.Item.expires && now >= result.Item.expires) || !result.Item.sess) {
                        fn(null, null);
                    } else {
